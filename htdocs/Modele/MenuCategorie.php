...
class menuCategorie
{
    ...
    private function chargerCategorie(){
        ...
        $requetteRecupererSuperCategorie = "SELECT idCategorie, nomCategorie FROM menuCategorie WHERE idPere IS NULL";
        ...
        while ($superCategorie = $resultatSuperCategorie->fetch()){
            $requetteRecupererSousCategorie = "SELECT idCategorie, nomCategorie FROM menuCategorie WHERE idPere = $superCategorie->idCategorie";
